        ...
        <div className="mainPage">
            ...
            <div className="mainPage_welcome_block relative" >
                ...
                <div className="absolute left-[50%] bottom-[20%] flex flex-col bg-[#FFF3E3] p-8">
                    ...
                    <button className="w-fit py-3 px-8 text-[12px] bg-[#BAA898] hover:bg-[#FFF3E3] border border-black font-semibold  rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300" type="text">ПОСМОТРЕТЬ</button>
                </div>
            </div>
            ...
            <Link className="flex justify-center mt-10" href={"/catalog"}><button className="w-fit py-3 px-8 text-[12px] border border-black bg-[#BAA898] font-semibold hover:bg-[#FFF3E3] rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300" type="text">БОЛЬШЕ</button></Link>
